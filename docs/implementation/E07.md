...
Nenhum DTO ou formulário aceita ownership do cliente. Autenticação fica adiada
conforme [`PUBLIC-SINGLE-WORKSPACE-MODE.md`](../decisions/PUBLIC-SINGLE-WORKSPACE-MODE.md).
...
Cobrir com Playwright/axe: acesso público no workspace fixo, tipo ausente, escolha de opção, refeição diferente, pulada, comentário, erro, reload, conflito, histórico, teclado e celular.
