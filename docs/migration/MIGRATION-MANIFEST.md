...
O manifesto registra 35 artefatos: 21 estão `VERIFIED` no destino público e 14 estão encerrados como `SKIPPED`; nenhuma linha permanece pendente. As fontes alimentares detalhadas permanecem privadas, enquanto somente metadados e resumos sanitizados da revisão podem ser publicados.
