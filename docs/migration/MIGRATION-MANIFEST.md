...
O manifesto registra 31 artefatos: 19 estão `VERIFIED` no destino público e 12 estão encerrados como `SKIPPED`; nenhuma linha permanece pendente. Os oito artefatos da E02-T02 apontam apenas para aliases privados neutros e permanecem `DO_NOT_PUBLISH`.
